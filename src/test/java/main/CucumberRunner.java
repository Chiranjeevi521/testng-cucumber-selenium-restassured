...
@CucumberOptions(strict = true, monochrome = true, features = "src/test/resources/ui_features", glue = "stepdefinition", format = {"pretty","json:target/cucumber.json"}, tags = { "@Regression,@JunitScenario,@TestngScenario" })
